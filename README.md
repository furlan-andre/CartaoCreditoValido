...
Projeto .NET 8 para validação de cartões de crédito, utilizando arquitetura em camadas, DDD, CQRS, SQL Server, RabbitMQ para comunicação assíncrona e XUnit para testes automatizados.
